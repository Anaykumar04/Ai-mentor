...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Account Creation Failed: System Error');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="flex-1 bg-[#02060f] flex items-center justify-center p-6 relative overflow-hidden selection:bg-cyan-500/30 font-main pt-20">
      ...
      <div className="w-full max-w-[440px] relative z-10">
        ...
        <div className="text-center mb-10">
           ...
           <p className="text-gray-500 text-sm font-bold tracking-wide uppercase">New Engineer Registration</p>
        </div>
           ...
           <div className="p-8 md:p-10 bg-[#0a1a2f] border border-white/5 space-y-8 rounded-[21px]">
             ...
             <div className="flex items-center justify-between border-b border-white/5 pb-4">
                <div className="flex items-center gap-2">
                   ...
                   <h1 className="text-xs font-black text-white uppercase tracking-[0.2em]">Create Identity</h1>
                </div>
                <Sparkles size={14} className="text-cyan-500/20" />
             </div>
             
             {error && (
               <div className="p-4 bg-rose-500/10 border border-rose-500/20 text-rose-500 text-[11px] font-black uppercase tracking-widest flex items-center gap-3 rounded-lg">
             ...
             <form onSubmit={handleSignup} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] ml-1">New Username</label>
                  <div className="relative group">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-cyan-400 transition-colors" size={16} />
                    <input
                      type="text"
                      ...
                      placeholder="Assign your handle..."
                      className="w-full bg-[#02060f]/60 border border-white/10 rounded-xl py-4 pl-12 pr-4 text-white text-sm focus:outline-none focus:border-cyan-500/50 focus:cyan-glow-border transition-all placeholder:text-gray-700 font-bold"
                      required
                    />
                  </div>
                ...
                <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center text-[10px] uppercase font-black tracking-widest text-gray-700 bg-[#0a1a2f] px-4">OR</div>
                </div>

                <button
                  type="button"
                  className="w-full h-14 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center gap-3 text-white text-xs font-bold hover:bg-white/10 transition-all group"
                >
             ...
             <div className="pt-6 border-t border-white/5 text-center">
                <div className="text-gray-500 text-[11px] font-bold flex flex-wrap items-center justify-center gap-2">
                  ...
                  <Link to="/login" className="text-cyan-400 hover:text-cyan-300 transition-colors font-black uppercase tracking-widest">
                     Sign in here
                  </Link>
